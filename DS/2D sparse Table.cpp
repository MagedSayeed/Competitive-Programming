...
vector<vector<int>> matrix = {
  ...
  // Define the comparison function: minimum
  auto cmp = [](int a, int b) { return min(a, b); };

  // Initialize 2D Sparse Table
  SP2d<int> rmq(matrix, cmp);

  // Query minimum in rectangle [(1,1) to (3,3)]
  int result = rmq.query(1, 1, 3, 3);
*/
